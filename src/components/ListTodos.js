...
const ListTodos = () => {
    ...
    const deleteTodo = async(id) => {
        ...
        try {
            const deleteTodo = await fetch(`https://oceanseighttodoappserver.herokuapp.com/todos/${id}`,{
                method: "DELETE"
            })
    ...
    const getTodos = async() => {
        try {
            ...
            const response = await fetch("https://oceanseighttodoappserver.herokuapp.com/todos")
    ...
    //         console.log(uid);
    //         const body = {uid}
    //         const response = await fetch("https://oceanseighttodoappserver.herokuapp.com/utodos", {
    //             method: "POST",
